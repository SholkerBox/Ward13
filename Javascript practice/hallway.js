...
const hallwayBackground = new Image();
hallwayBackground.src = '/Ward/Hallway.png';
...
collisionMapImage.src = "/Ward/Hallwaycollision.png"; 

const overlayImage = new Image ();
overlayImage.src = "/Ward/lighting Hallway.png"
...
const door = [
  {
    x: 0, // X-coordinate of the door (in tiles)
    y: 2, // Y-coordinate of the door (in tiles)
    ...
    targetFile: "Maingame.html", // The HTML file to load
...
const door2 = [
  {
    x: 27, // X-coordinate of the door (in tiles)
    y: 5, // Y-coordinate of the door (in tiles)
    width: 1, // Adjust width as needed (in tiles)
    height: 1, // Adjust height as needed (in tiles)
    isDoor: true, // Flag this object as a door for specific interaction
    targetFile: "Doctors_office.html", // The HTML file to load
    interactionKey: "f", // The key to press for interaction
    isPlayerNear: false, // To track if the player is near
  },
];
...
function update() {
  ...
  door.forEach((object) => {
    ...
    const interactionDistance = 1.5; // Adjust as needed
...
function draw() {
  ...
  // Draw Background
  const bgWidth = hallwayBackground.width;
  const bgHeight = hallwayBackground.height;
  const scale = 0.55; 
